	...
	return (
		<div className="min-h-screen bg-slate-50 p-6 space-y-6">
			...
			<div className="rounded-3xl bg-gradient-to-r from-indigo-600 to-blue-600 p-8 text-white shadow-lg">
				<h1 className="text-3xl font-bold">{event.basic.title}</h1>

				<p className="mt-2 text-indigo-100">
					Manage registrations, participants and results for this
					event.
				</p>
			...
			<div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
				...
				<div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
					...
					<h2 className="mt-2 text-xl font-bold text-emerald-700">
						{event.registration.config.required
							? "Enabled"
							: "Disabled"}
					</h2>
				</div>
			...
			<div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
				...
				<div className="p-6">
					...
					{activeTab === "results" && (
						<TeacherEventResults event={event} />
					)}
				</div>
			</div>
		</div>
