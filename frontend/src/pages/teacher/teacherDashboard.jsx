			...
			<div className="mx-auto max-w-7xl space-y-8">
				...
				<div className="rounded-3xl bg-gradient-to-r from-indigo-700 via-indigo-600 to-sky-600 px-8 py-6 text-white shadow-xl">
					...
					<p className="mt-3 max-w-3xl text-sm leading-7 text-indigo-100">
						Coordinate events, manage participants, oversee student
						coordinators, and keep every event organized from one
						unified dashboard.
					</p>
					...
					<div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
						<div>
							...
							<p className="mt-1 text-sm text-slate-500">
								Manage, edit and monitor all events assigned to
								you.
							</p>
						</div>
