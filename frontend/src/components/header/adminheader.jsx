	...
	return (
		<header className="bg-white/80 backdrop-blur border-b border-blue-200 px-6 py-3 flex items-center justify-between">
			...
			<div className="flex items-center gap-4">
				...
				<button
					onClick={logout}
					className="inline-flex items-center gap-2 rounded-xl border border-rose-200 bg-rose-50 px-4 py-2 text-sm font-semibold text-rose-600 shadow-sm transition hover:-tranblue-y-0.5 hover:border-rose-300 hover:bg-rose-100 hover:shadow-md"
				>
					Logout
				</button>
			</div>
