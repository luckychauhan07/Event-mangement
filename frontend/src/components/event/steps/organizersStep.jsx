...
const OrganizersStep = forwardRef(({ eventData, setEventData }, ref) => {
	...
	useEffect(() => {
		if (eventData.primaryCoordinator && !search) {
			setSearch(eventData.primaryCoordinator);
		}
			...
			<div className="flex items-center gap-3 pb-4 border-b border-slate-100">
				...
				<div>
					...
					<p className="text-sm text-slate-500">
						Select the organizing department and coordinator
					</p>
				</div>
			</div>
				...
				<div className="md:col-span-2">
					...
					<div className="relative">
						...
						<select
							...
							onChange={(e) =>
								update("organizerUnit", e.target.value)
							}
						>
							...
							<option value="CSE Department">
								CSE Department
							</option>
							<option value="ECE Department">
								ECE Department
							</option>
							<option value="EEE Department">
								EEE Department
							</option>
							<option value="Mechanical Department">
								Mechanical Department
							</option>
							<option value="Civil Department">
								Civil Department
							</option>
						</select>
					</div>
