...
const MediaStep = ({ eventData, setEventData }) => {
		...
		<div className="space-y-6">
			...
			<div className="flex items-center gap-3 pb-4 border-b border-slate-100">
				...
				<div>
					...
					<p className="text-sm text-slate-500">Upload event posters, videos, and documents</p>
				</div>
			</div>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-5">
				<div>
					...
					<div className="relative">
						...
						<input
							...
							accept="image/*"
							onChange={(e) =>
								update("eventPoster", e.target.files?.[0] || null)
							}
				...
				<div>
					...
					<p className="text-xs text-slate-400 mt-1">Accepted formats: PDF, DOC, DOCX, TXT</p>
				</div>
